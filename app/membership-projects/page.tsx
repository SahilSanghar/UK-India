  ...
  return (
    <>
      ...
      >
        ...
        <BoxImageText
          description={`The UKIBC works with our members and clients, namely UK and
Indian businesses, and with Government in both countries to
promote trade and investment in the UK-India economic corridor.
Our policy and advocacy efforts are far and wide and cut across multiple sectors, from higher education to food and drink to healthcare and in between.
We are uniquely connected to all levels of UK and Indian Government, both national and local administrations. This gives us an unrivalled ability to advocate on behalf of our members’ interests towards delivering trade, investment, growth, and jobs <br/><br/>Take a look at some of our advocacy wins below. <br/><br/> You can also read our <a href="/reports/uk-india-business-council-advocating-business-success-in-2020/" style="color: #012d6b; text-decoration: underline;">Advocacy Report for 2020</a>, which outlines the breadth of advocacy work that the UKIBC has delivered in the last twelve months and sets out our objectives and plans for 2020.  `}
          images={[
        ...
        <div className="md:w-[70%] w-[95%] flex flex-col text-center gap-6 sm:gap-10 mt-10 sm:mt-20 mb-6 sm:mb-10 bg-black/5 rounded-xl px-3 sm:px-10 py-6 sm:py-10">
          <h1 className="text-xl sm:text-2xl font-bold text-black md:w-[50%] w-full sm:w-[90%] mx-auto text-center">
            On FSSAI publishing an office order about in shell nuts (almonds)
            standards.
          </h1>
        ...
        <div className="w-full h-fit flex flex-col gap-6 sm:gap-10 mt-8 sm:mt-10 py-10 sm:py-20 items-center justify-center bg-black/5">
          ...
          <Carousel
            data={[
              {
                quote:
                  "Food Safety and Standards Authority of India publish standards for Alcohol-Free Beer (August 2020) ",
                des: `The Government of India’s (GOI) Food Safety and Standards Authority of India (FSSAI) has issued a directive to operationalise certain provisions of the draft Food Safety and Standards (Alcoholic Beverages) Amendment Regulations, 2020. The provisions include the addition of alcohol-free beer as a separate product category. <br/>UKIBC, on behalf of the UK food and drink companies, engaged with FSSAI officials on several occasions, including on the publication of the alcohol-free beer.   `,
...
`,
              ...
              },
              {
                ...
                des: `The UKIBC provided a voice for UK universities asking for greater clarity from the Home Office on the new Graduate Immigration Route beginning in 2021. In light of fears around students studying online due to COVID-19, at least for initial months and potentially most of the first year of 2020-21 academic year, the UKIBC asked the Home Office for clarity that students who studied online initially would still be eligible for the new GIR, which the Home Office subsequently provided.`,
...
`,
              ...
              },
              {
                ...
                des: `Following UKIBC’s repeated representations to the Food Safety and Standards Authority of India (FSSAI) on their stringent labelling requirements, the FSSAI have confirmed the inclusion of the rectifiable labelling requirement.<br/><br/>The FSSAI, with a view to facilitating trade, allows rectification of labelling by affixing a single non-detachable sticker or by any other non-detachable method next to the principal display panel without altering or masking the original label information in any manner.<br/><br/>UKIBC has engaged with neutral allies, and the FSSAI to secure this win for UK businesses exporting to India.`,
              ...
              },
              {
                ...
                des: `In December 2019, the National Pharmaceutical Pricing Authority (NPPA), India’s drug pricing regulator, increased the ceiling prices of 21 formulations by 50 percent.<br/><br/>
...
The UKIBC has long made the point that drug pricing requires a careful balancing act. If the price is too low, innovation will be discouraged and reduce the availability of important medicines. This announcement by the NPPA is therefore a step in the right direction, and one which will benefit the Indian healthcare system and those that depend on it.<br/><br/>
`,
...
`,
              ...
              {
                quote:
                  "Reinstatement of UK post-study working visa to two years (September 2019) ",
...
Not only does the reinstatement to two years improve the competitiveness of the UK’s education offer on the world-stage, but rightly encourages many of the best Indian graduates of UK universities to retain their talent within the UK. In turn this provides new graduates an opportunity to gain work experience after their degree to find employment.
`,
              ...
              {
                quote:
                  "UKIBC-led CEO round table in the state of Maharashtra leads to advocacy win in drink sector (January 2019)",
                des: `A roundtable in January 2019 in Mumbai involving the Maharashtra Chief Minister and CEOs from UKIBC members led directly to the constitution of a Task Force, which held 32 follow up meetings with relevant officials under the leadership of the Maharashtra Principal Secretary.<br/><br/>
Around 75 recommendations were made to the Task Force and the Government issued 30 notifications/circulars to introduce large scale simplification of procedures, the delegation of powers, and removing documents in the regulatory ecosystem, including:<br/><br/>
...
`,
              ...
              },
              {
                ...
                des: `In 2018, the Law Commission of India submitted a comprehensive and pragmatic legal framework to the Indian Government that recommends the regulation of gambling and sports betting in India.<br/><br/>
The recommendations were put together following several rounds of stakeholder consultations and inputs. We are delighted that the UKIBC and UK industry were closely engaged in the process, including hosting the Law Commission Chairman in the UK, providing insights into how the UK regulates sports betting.<br/><br/>
This move, we believe, is positive to protect the integrity of sport, stamp out corruption, expand the tax base, and stimulate more investment and job creation in the Indian economy.
`,
            ...
            data={[
              {
                ...
                des: `On the back of submissions made by the UKIBC to DPIIT and Invest India, as well as directly to the Reserve Bank of India and Small Industries Development Bank of India, the Government of India has enacted several positive steps to support companies facing liquidity constraints and lockdown restrictions.
`,
              ...
              },
              {
                ...
                des: `In May 2020, the UKIBC made a submission to the Ministry of Electronics and Information Technology (MeitY) and Department of Telecom (DoT).  
This submission highlights the importance of having a diverse, vibrant and robust tech sector that can be drawn on to offer expertise and delivery capabilities to governments and citizens across sectors, and the need for collaboration between Governments and the tech sector.     `,
              ...
              },
              {
                ...
                des: `The coronavirus lockdown has meant that educational institutions across the country have had to temporarily close their doors, resulting in an increased demand for online learning. Universities and colleges across the world are working hard to move all their courses and curricula onto digital platforms as quickly as possible to ensure the least disruption to students’ education.<br/>
Accordingly, the UKIBC wrote to the Ministry of Human Resource Development (MHRD) on behalf of our members with practical and important recommendations to support their efforts.`,
